...
char *name[16], components[64], *last_token;
int nk;

/**
 * Gets string from FD.
 * @param File descriptor to get line
 * @param Buffer to store string
 * @param Max size (0 == unlimited)
 * @param (Optional) EOF flag
...
/**
 * Gets secret string from STDIN.
 * @param Buffer to store string
 * @param Max size (0 == unlimited)
 * @return Length of string
 */
int getsecret(char *buf, int size) {
    int i = 0, done = 0;
    char c;
